...
export class MasterPriceListListComponent implements OnInit {
  ...
  getAccessoryProducts() {
    Helpers.setLoading(true);
    this.masterPriceListService.getAccessoryProducts(this.pageSize, this.page, this.search).subscribe(
      results => {
  ...
  getFabricProducts() {
    Helpers.setLoading(true);
    this.masterPriceListService.getFabricProducts(this.pageSize, this.page, this.search, this.selectedCollection, this.selectedQuality, this.selectedDesign, this.shadeId).subscribe(
      results => {
        this.masterPriceListList = results.data;
        this.totalCount = results.totalCount;
        if (this.totalCount == 0) {
  ...
  getFoamProducts() {
    Helpers.setLoading(true);
    this.masterPriceListService.getFoamProducts(this.pageSize, this.page, this.search, this.selectedCollection, this.selectedQuality, this.selectedDensity, this.selectedSize, this.fomSizeId).subscribe(
      results => {
        this.masterPriceListList = results.data;
        this.totalCount = results.totalCount;
        if (this.totalCount == 0) {
  ...
  getMattressProducts() {
    Helpers.setLoading(true);
    this.masterPriceListService.getMattressProducts(this.pageSize, this.page, this.search, this.selectedCollection, this.selectedQuality, this.selectedThickness, this.matSizeId ).subscribe(
      results => {
        this.masterPriceListList = results.data;
        this.totalCount = results.totalCount;
        if (this.totalCount == 0) {
  ...
  getRugProducts() {
    Helpers.setLoading(true);
    this.masterPriceListService.getRugProducts(this.pageSize, this.page, this.search, this.selectedCollection, this.selectedQuality, this.selectedDesign, this.shadeId).subscribe(
      results => {
        this.masterPriceListList = results.data;
        this.totalCount = results.totalCount;
        if (this.totalCount == 0) {
  ...
  getWallpaperProducts() {
    Helpers.setLoading(true);
    this.masterPriceListService.getWallpaperProducts(this.pageSize, this.page, this.search, this.selectedCollection, this.selectedQuality, this.selectedDesign, this.shadeId).subscribe(
      results => {
        this.masterPriceListList = results.data;
        this.totalCount = results.totalCount;
        if (this.totalCount == 0) {
  ...
  exporttoCSV(data, columns, categoryName) {
    let exprtcsv: any[] = [];
    let _tempList = data;
    let exportFileName: string = "MasterPriceListReportFor" + categoryName + "_";
